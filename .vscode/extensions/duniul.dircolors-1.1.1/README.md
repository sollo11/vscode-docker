<p align="center">
  <img width="500" src="https://github.com/duniul/vscode-dircolors/raw/master/images/dircolors-syntax-example.png">
</p>
...
| `dircolors.formatColumns` | `true`  | Toggle whether or not neighboring declarations should be formatted in columns (example: [true](https://github.com/duniul/vscode-dircolors/blob/master/images/column-format-enabled.png)/[false](https://github.com/duniul/vscode-dircolors/blob/master/images/column-format-disabled.png)). |
